...
pub static CUSTOM_PLAYER_PROP_IDS: phf::Map<&'static str, u32> = phf_map! {
    ...
    "inventory_weapon_cosmetics" => INVENTORY_WEAPON_COSMETICS_ID,
    ...
    "usercmd_up_move" => USERCMD_UPMOVE,
...
pub static TYPEHM: phf::Map<&'static str, PropType> = phf_map! {
    ...
    "usercmd_up_move" => PropType::Player,
    ...
    "inventory_weapon_cosmetics" => PropType::Custom,
...
pub static FRIENDLY_NAMES_MAPPING: phf::Map<&'static str, &'static str> = phf_map! {
    ...
    "inventory_weapon_cosmetics" => "inventory_weapon_cosmetics",
