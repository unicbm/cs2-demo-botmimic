...
pub const WEAPON_ATTRIBUTE_DEF_INDEX_ID: u32 = 11000000;
...
pub const USERCMD_UPMOVE: u32 = 100000043;
    ...
    fn set_special_ids(&mut self, name: &str, is_grenade_or_weapon: bool, id: u32) {
        if is_grenade_or_weapon {
            match name {
                ...
                "m_iItemIDHigh" => self.special_ids.item_id_high = Some(id),
                "m_iItemIDLow" => self.special_ids.item_id_low = Some(id),
                "m_iAccountID" => self.special_ids.item_account_id = Some(id),
