...
- 支持武器 paint kit/seed/wear、刀具 item def + paint kit/seed/wear，以及 demo 暴露时
  的手套 item def + paint kit/wear。如果 demoparser 暴露了手套 item def、paint、wear
...
- 不应用贴纸、挂件/keychain、探员、nametag 或 StatTrak。
