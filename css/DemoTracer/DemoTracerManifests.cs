...
public sealed partial class DemoTracerPlugin
{
    ...
    private sealed class ManifestRound
    {
        ...
        [JsonPropertyName("bomb_planted_snapshot")]
        public RoundAnchorSnapshot? BombPlantedSnapshot { get; set; }

        [JsonPropertyName("duration_seconds")]
        public float DurationSeconds { get; set; }
    }

    private sealed class RoundAnchorSnapshot
    {
        [JsonPropertyName("tick")]
        public int Tick { get; set; }

        [JsonPropertyName("seconds_after_live")]
        public float SecondsAfterLive { get; set; }

        [JsonPropertyName("bomb")]
        public RoundBombSnapshot? Bomb { get; set; }

        [JsonPropertyName("players")]
        public List<RoundPlayerSnapshot> Players { get; set; } = new();
    }

    private sealed class RoundBombSnapshot
    {
        [JsonPropertyName("tick")]
        public int Tick { get; set; }

        [JsonPropertyName("planter_steam_id")]
        public ulong? PlanterSteamId { get; set; }
    ...
    private sealed class RoundPlayerSnapshot
    {
        ...
        [JsonPropertyName("buttons1")]
        public ulong Buttons1 { get; set; }

        [JsonPropertyName("buttons2")]
        public ulong Buttons2 { get; set; }

        [JsonPropertyName("duck_amount")]
        public float? DuckAmount { get; set; }

        [JsonPropertyName("duck_speed")]
        public float? DuckSpeed { get; set; }

        [JsonPropertyName("ladder_normal")]
        public float[]? LadderNormal { get; set; }

        [JsonPropertyName("ducked")]
        public bool? Ducked { get; set; }

        [JsonPropertyName("ducking")]
        public bool? Ducking { get; set; }

        [JsonPropertyName("desires_duck")]
